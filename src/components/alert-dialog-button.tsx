...
export function AlertDialogButton({ car, ...props }: AlertDialogButtonProps) {
    ...
    <AlertDialog.Root>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Content className="fixed left-[50%] top-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] space-y-4 rounded-[6px] bg-white p-[25px] text-primaryapp-800 shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] data-[state=open]:animate-contentShow focus:outline-none">
          ...
          <AlertDialog.Description className="text-primaryapp-600">
          ...
          <div className="flex justify-end gap-4">
            <AlertDialog.Cancel asChild>
              <button className="group flex items-center justify-center gap-2 rounded-md border px-3 py-2 shadow-sm outline-none focus-within:ring-2 focus-within:ring-primaryapp-900/40 disabled:cursor-not-allowed">
                Cancelar
            ...
            <AlertDialog.Cancel asChild>
              <button
                className="group flex items-center justify-center gap-2 rounded-md border border-highlight-300 bg-red-200/20 px-3 py-2 text-highlight-500 shadow-sm outline-none focus-within:ring-2 focus-within:ring-primaryapp-900/40 hover:border-white hover:bg-highlight-500 hover:text-white hover:opacity-100 focus-visible:ring-1 focus-visible:ring-highlight-500 disabled:cursor-not-allowed"
